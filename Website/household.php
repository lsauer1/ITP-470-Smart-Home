...
<body>
  ...
  if (!isset($_POST['id']) && !isset($_GET['id'])) {
    ...
    echo '<tr class="mobile-remove"><form action="add_household.php" method="post">';
    echo '<td class="mobile-remove"><label for="name" required class="col-form-label text-sm-right user-label mobile-remove"><h5>Create New Household:</h5></label></td>';
    echo '<td><input type="text" name="name1" placeholder="Household Name" class="form-control"></td>';
    echo '<td><input type="submit" id="create-house" class="btn btn-primary" value="Create Household"></td>';
    echo '<div class="row justify-content-center align-items-center mobile-show">';
    echo '<div class="input-group mb-3 flex-nowrap">';

  echo '<input type="text" name="name2" placeholder="New Household Name" class="form-control" aria-label="Name" aria-describedby="basic-addon1">';
    echo '<div class="input-group-append"><input type="submit" id="create-house" class="btn btn-primary" value="Create"></div></div><br>';
    echo '</form></tr>  </tbody> </table></div>';
