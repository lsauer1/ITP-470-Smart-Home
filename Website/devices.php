...
<body>
  ...
  if (isset($_SESSION['email'])) {
    ...
    foreach ($household_relations as $houseid) {
      $query = "SELECT *, households.name AS household_name, devices.name AS device_name FROM devices JOIN households ON households.id = devices.household_id WHERE devices.household_id = ? ORDER BY favorite";
    ...
    array_multisort($favorite, SORT_DESC, $devices);
