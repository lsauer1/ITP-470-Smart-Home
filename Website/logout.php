...
<body>
  ...
  <div class="jumbotron jumbotron-fluid">
    ...
    <h1 class="display-4 text-dark text-center">You are beinging signed out!</h1>
    <p class="lead text-dark text-center">Thank you for visiting.</p>
    <hr class="my-4">
    <p class="text-dark text-center">Return to the homepage?      <?php 
    session_reset();
    $_SESSION = []; 
    ?></p>
