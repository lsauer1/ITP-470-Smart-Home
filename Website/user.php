    ...
    <div class="mobile-row">
      <div class="col-12">
        <div class="input-group mb-3 flex-nowrap">
          ...
          <input readonly="readonly" type="text" class="form-control" name="adafruit_key" placeholder="Adafruit IO Key" value=<?php echo '"'.$master_aiokey.'"' ?>>      </div>
        </div>
      </div>
      <div class="mobile-row">
        <div class="col-12">
          <div class="input-group mb-3 flex-nowrap">
            ...
            <input readonly="readonly" type="text" class="form-control" name="adafruit_user" placeholder="Adafruit IO Username" value=<?php echo '"'.$master_aiouser.'"' ?>>      </div>
          </div>
