...
function windowSize() {
    if(window.location.href.includes('http://303.itpwebdev.com/~sauer/Final%20Project/user.php')) {
        if ($( window ).width() < 767) {
   ...
   if(window.location.href.includes('http://303.itpwebdev.com/~sauer/Final%20Project/household.php')) {
    if ($( window ).width() < 767) {
...
$(window).load(function() {
    $('.carousel').carousel();
    windowSize();
    if (window.location.href.includes('http://303.itpwebdev.com/~sauer/Final%20Project/delete_user.php')) {
        signOut();
    }
  ...
  if (sessionStorage.getItem('email') != null) {
    ...
    $("#signout").hide();
    $("#submit_user").hide();
    if (!('http://303.itpwebdev.com/~sauer/Final%20Project/' == window.location.href || window.location.href.includes('index.php') || window.location.href.includes('login.php') || window.location.href.includes('delete_user.php') || window.location.href.includes('login.php'))) {
